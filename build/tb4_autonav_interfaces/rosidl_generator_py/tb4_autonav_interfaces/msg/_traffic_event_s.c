...
bool tb4_autonav_interfaces__msg__traffic_event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tb4_autonav_interfaces.msg._traffic_event.TrafficEvent", full_classname_dest, 54) == 0);
  }
  tb4_autonav_interfaces__msg__TrafficEvent * ros_message = _ros_message;
  {  // stamp
...
{
  /* NOTE(esteve): Call constructor of TrafficEvent */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("tb4_autonav_interfaces.msg._traffic_event");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TrafficEvent");
