...
static const _TrafficEvent_type_support_symbol_names_t _TrafficEvent_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tb4_autonav_interfaces, msg, TrafficEvent)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tb4_autonav_interfaces, msg, TrafficEvent)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, tb4_autonav_interfaces, msg, TrafficEvent)() {
  return &::tb4_autonav_interfaces::msg::rosidl_typesupport_c::TrafficEvent_message_type_support_handle;
}
