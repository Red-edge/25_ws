...
#include "demo_interfaces_test/msg/detail/test_msg__rosidl_typesupport_fastrtps_c.h"
...
#include "demo_interfaces_test/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _TestMsg__ros_msg_type = demo_interfaces_test__msg__TestMsg;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_demo_interfaces_test
size_t get_serialized_size_demo_interfaces_test__msg__TestMsg(
  const void * untyped_ros_message,
...
static uint32_t _TestMsg__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_demo_interfaces_test__msg__TestMsg(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_demo_interfaces_test
size_t max_serialized_size_demo_interfaces_test__msg__TestMsg(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = demo_interfaces_test__msg__TestMsg;
    is_plain =
      (
...
static size_t _TestMsg__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_demo_interfaces_test__msg__TestMsg(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, demo_interfaces_test, msg, TestMsg)() {
